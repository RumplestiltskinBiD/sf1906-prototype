...
export const DISTRICT_ADJACENCY = {
  ...
  northbeach:['marina','pacific','chinatown'],
  chinatown:['northbeach','civic','financial'],
  pacific:['marina','northbeach','western','civic'],
  financial:['chinatown','civic','soma'],
  civic:['pacific','western','chinatown','financial','haight','soma'],
  western:['pacific','civic','innerrichmond','park','haight'],
  ...
  innersunset:['park','sunset','haight','mission'],
