...
function renderOffice(){
  ...
  const procurementChip=procurement?`<span class="procurement-chip">Procurement · ${procurement} купленных материал${procurement===1?'':'а'} по $0</span>`:'';
