...
function renderSupply(){
  ...
  el.innerHTML='<div class="supply-label"><strong>SUPPLY YARD</strong><span>v0.25 · movement + mobile UX</span></div><div class="supply-items">'+RESOURCE_ORDER.map(type=>'<span class="supply-resource '+materialClass(type)+'"><b>'+materialShort(type)+'</b><span>'+materialLabel(type)+'</span><strong>function renderCityActions(){
